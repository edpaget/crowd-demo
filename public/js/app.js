...
goog.provide("crowd_demo.websocket");
...
goog.require("goog.events");
crowd_demo.websocket.create = function create() {
  return new goog.net.WebSocket
};
crowd_demo.websocket.configure = function() {
  var configure = null;
  var configure__2 = function(soc, message) {
    return configure.call(null, soc, message, null, null, null)
  };
  var configure__3 = function(soc, message, opened) {
    return configure.call(null, soc, message, opened, null, null)
  };
  var configure__4 = function(soc, message, opened, error) {
    return configure.call(null, soc, message, opened, error, null)
  };
  var configure__5 = function(soc, message, opened, error, closed) {
    var handler_14426 = new goog.events.EventHandler;
    handler_14426.listen(soc, goog.net.WebSocket.EventType.MESSAGE, function(payload) {
      return message.call(null, payload)
    });
    if(cljs.core.truth_(opened)) {
      handler_14426.listen(soc, goog.net.WebSocket.EventType.OPENED, opened)
    }else {
    }
    if(cljs.core.truth_(error)) {
      handler_14426.listen(soc, goog.net.WebSocket.EventType.ERROR, error)
    }else {
    }
    if(cljs.core.truth_(closed)) {
      handler_14426.listen(soc, goog.net.WebSocket.EventType.CLOSED, closed)
    }else {
    }
    return soc
  };
  configure = function(soc, message, opened, error, closed) {
    switch(arguments.length) {
      case 2:
        return configure__2.call(this, soc, message);
      case 3:
        return configure__3.call(this, soc, message, opened);
      case 4:
        return configure__4.call(this, soc, message, opened, error);
      case 5:
        return configure__5.call(this, soc, message, opened, error, closed)
    }
    throw new Error("Invalid arity: " + arguments.length);
  };
  configure.cljs$lang$arity$2 = configure__2;
  configure.cljs$lang$arity$3 = configure__3;
  configure.cljs$lang$arity$4 = configure__4;
  configure.cljs$lang$arity$5 = configure__5;
  return configure
}();
crowd_demo.websocket.open_BANG_ = function open_BANG_(soc, url) {
  try {
    soc.open(url);
    return soc
  }catch(e14428) {
    if(cljs.core.instance_QMARK_.call(null, Error, e14428)) {
      var e = e14428;
      return console.log("Your Browser Doesn't Support WebSockets", e)
    }else {
      if("\ufdd0'else") {
        throw e14428;
      }else {
...
crowd_demo.websocket.close_BANG_ = function close_BANG_(soc) {
  return soc.close()
};
crowd_demo.websocket.emit_BANG_ = function emit_BANG_(soc, message) {
  return soc.send(message)
};
goog.provide("crowd_demo.canvas");
goog.require("cljs.core");
crowd_demo.canvas.surface = function surface(canvas) {
  return canvas.getContext("2d")
};
crowd_demo.canvas.start_draw_BANG_ = function start_draw_BANG_(surface, x, y, p__6832) {
  var map__6834 = p__6832;
  var map__6834__$1 = cljs.core.seq_QMARK_.call(null, map__6834) ? cljs.core.apply.call(null, cljs.core.hash_map, map__6834) : map__6834;
  var cap = cljs.core._lookup.call(null, map__6834__$1, "\ufdd0'cap", null);
  var width = cljs.core._lookup.call(null, map__6834__$1, "\ufdd0'width", null);
  var color = cljs.core._lookup.call(null, map__6834__$1, "\ufdd0'color", null);
...
crowd_demo.canvas.draw_line_BANG_ = function draw_line_BANG_(surface, p__6835, opts) {
  var vec__6839 = p__6835;
  var x = cljs.core.nth.call(null, vec__6839, 0, null);
  var y = cljs.core.nth.call(null, vec__6839, 1, null);
  var points = cljs.core.nthnext.call(null, vec__6839, 2);
  crowd_demo.canvas.start_draw_BANG_.call(null, surface, x, y, opts);
  var G__6840 = cljs.core.seq.call(null, points);
  while(true) {
    if(G__6840) {
      var vec__6841 = cljs.core.first.call(null, G__6840);
      var x__$1 = cljs.core.nth.call(null, vec__6841, 0, null);
      var y__$1 = cljs.core.nth.call(null, vec__6841, 1, null);
      crowd_demo.canvas.add_segment_BANG_.call(null, surface, x__$1, y__$1);
      var G__6842 = cljs.core.next.call(null, G__6840);
      G__6840 = G__6842;
      continue
    }else {
      return null
...
crowd_demo.canvas.erase_BANG_ = function erase_BANG_(canvas) {
  var surface = crowd_demo.canvas.surface.call(null, canvas);
  return surface.clearRect(0, 0, canvas.width, canvas.height)
};
...
goog.provide("crowd_demo.sender");
goog.require("cljs.core");
goog.require("goog.events");
goog.require("goog.dom");
goog.require("crowd_demo.canvas");
goog.require("crowd_demo.websocket");
crowd_demo.sender.current_marking = cljs.core.PersistentVector.EMPTY;
crowd_demo.sender.all_markings = cljs.core.PersistentVector.EMPTY;
crowd_demo.sender.current_line_opts = cljs.core.ObjMap.fromObject(["\ufdd0'color", "\ufdd0'cap", "\ufdd0'width"], {"\ufdd0'color":"orange", "\ufdd0'cap":"round", "\ufdd0'width":10});
crowd_demo.sender.submitted_line_opts = cljs.core.ObjMap.fromObject(["\ufdd0'color", "\ufdd0'cap", "\ufdd0'width"], {"\ufdd0'color":"blue", "\ufdd0'cap":"round", "\ufdd0'width":10});
crowd_demo.sender.send_marking = function send_marking(soc) {
  return crowd_demo.websocket.emit_BANG_.call(null, soc, crowd_demo.sender.current_marking)
};
...
crowd_demo.sender.stop_tracking_BANG_ = function stop_tracking_BANG_(surface, ev) {
  crowd_demo.sender.all_markings = cljs.core.conj.call(null, crowd_demo.sender.all_markings, crowd_demo.sender.current_marking);
  var canvas = goog.dom.getElement("subject-canvas");
  goog.events.removeAll(canvas, "mousemove");
  crowd_demo.canvas.erase_BANG_.call(null, canvas);
  var G__15080 = cljs.core.seq.call(null, crowd_demo.sender.all_markings);
  while(true) {
    if(G__15080) {
      var marking = cljs.core.first.call(null, G__15080);
      crowd_demo.canvas.draw_line_BANG_.call(null, crowd_demo.canvas.surface.call(null, canvas), marking, crowd_demo.sender.submitted_line_opts);
      var G__15081 = cljs.core.next.call(null, G__15080);
      G__15080 = G__15081;
      continue
    }else {
      return null
...
crowd_demo.sender.do_canvas_mousedown = function do_canvas_mousedown(ev) {
  ...
  var surface = crowd_demo.canvas.surface.call(null, canvas);
  crowd_demo.sender.current_marking = cljs.core.PersistentVector.EMPTY;
  goog.events.listen(canvas, "mousemove", function(p1__15078_SHARP_) {
    return crowd_demo.sender.track_marking_BANG_.call(null, surface, p1__15078_SHARP_)
  });
  goog.events.listenOnce(canvas, "mouseup", crowd_demo.sender.stop_tracking_BANG_);
  return crowd_demo.canvas.start_draw_BANG_.call(null, surface, ev.offsetX, ev.offsetY, crowd_demo.sender.current_line_opts)
};
crowd_demo.sender.start_sender = function start_sender(soc) {
  var button = goog.dom.getElement("erase");
  var canvas = goog.dom.getElement("subject-canvas");
  goog.events.listen(button, "click", function() {
    return crowd_demo.canvas.erase_BANG_.call(null, canvas)
  });
  goog.events.listen(canvas, "mousedown", crowd_demo.sender.do_canvas_mousedown);
  return goog.events.listen(canvas, "mouseup", function() {
    return crowd_demo.sender.send_marking.call(null, soc)
  })
};
...
goog.provide("crowd_demo.history");
goog.require("cljs.core");
goog.require("goog.events");
goog.require("goog.History.EventType");
goog.require("goog.History");
crowd_demo.history.create = function create() {
  return new goog.History
};
crowd_demo.history.listen_hash_change = function listen_hash_change(hist, nav_function) {
  goog.events.listen(hist, goog.History.EventType.NAVIGATE, nav_function);
  return hist
};
crowd_demo.history.start_BANG_ = function start_BANG_(hist) {
  hist.setEnabled(true);
  return hist
};
crowd_demo.history.router = function router(routes) {
  return function route(ev) {
    return cljs.core.second.call(null, cljs.core.first.call(null, cljs.core.filter.call(null, function(p1__7823_SHARP_) {
      return cljs.core._EQ_.call(null, ev.token, cljs.core.first.call(null, p1__7823_SHARP_))
    }, routes))).call(null)
  }
};
goog.provide("crowd_demo.core");
goog.require("cljs.core");
goog.require("crowd_demo.websocket");
goog.require("crowd_demo.sender");
goog.require("crowd_demo.history");
crowd_demo.core.start_app = function start_app() {
  var hist = crowd_demo.history.create.call(null);
  var soc = crowd_demo.websocket.open_BANG_.call(null, crowd_demo.websocket.configure.call(null, crowd_demo.websocket.create.call(null), function(p1__14671_SHARP_) {
    return console.log(p1__14671_SHARP_)
  }), "ws://localhost:8080/marks");
  return crowd_demo.history.start_BANG_.call(null, crowd_demo.history.listen_hash_change.call(null, hist, crowd_demo.history.router.call(null, cljs.core.PersistentVector.fromArray([cljs.core.PersistentVector.fromArray(["", function() {
    return crowd_demo.sender.start_sender.call(null, soc)
  }], true), cljs.core.PersistentVector.fromArray(["/sender", crowd_demo.sender.start_sender.call(null, soc)], true)], true))))
};
crowd_demo.core.start_app.call(null);
