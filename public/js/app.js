...
crowd_demo.sender.do_send_button_clicked = function do_send_button_clicked(soc) {
...
crowd_demo.sender.start_sender = function start_sender() {
  ...
  goog.events.listen(button, "click", crowd_demo.sender.do_send_button_clicked);
  return goog.events.listen(canvas, "mousedown", crowd_demo.sender.do_canvas_mousedown)
};
...
crowd_demo.history.router = function router(routes) {
  return function route(ev) {
    return cljs.core.map.call(null, cljs.core.filter.call(null, routes, function(route__$1) {
      return cljs.core._EQ_.call(null, evtoken, cljs.core.first.call(null, route__$1))
    }), function(route__$1) {
      return cljs.core.apply.call(null, cljs.core.rest.call(null, route__$1), cljs.core.first.call(null, route__$1))
    })
  }
};
...
crowd_demo.core.start_app = function start_app() {
  ...
  console.log(hist);
  return crowd_demo.history.start_BANG_.call(null, crowd_demo.history.listen_hash_change.call(null, hist, crowd_demo.history.router.call(null, cljs.core.PersistentVector.fromArray([cljs.core.PersistentVector.fromArray(["", crowd_demo.sender.start_sender], true), cljs.core.PersistentVector.fromArray(["#/sender", crowd_demo.sender.start_sender], true)], true))))
};
